...
<body class="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-gray-100 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="relative bg-gray-900/80 backdrop-blur-lg border border-gray-700/50 rounded-2xl shadow-2xl p-8 max-w-md w-full mx-auto">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent">Welcome Back</h1>
        ...
        <main>
            <div data-controller="auth-visibility" data-auth-visibility-user-value="{{ Auth::check() }}">
                <div data-auth-visibility-target="authForm">
                    ...
                    <form action="{{ route('login') }}" method="POST" class="space-y-6" data-action="submit->auth-visibility#submitLoginForm">
                        @csrf
                        <div class="group">
                            <label for="login-email" class="block text-sm font-medium text-gray-300 mb-2 group-focus-within:text-purple-400 transition-colors">Email Address</label>
                            <div class="relative">
                        ...
                        <div class="group">
                            <label for="login-password" class="block text-sm font-medium text-gray-300 mb-2 group-focus-within:text-purple-400 transition-colors">Password</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-500 group-focus-within:text-purple-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                        ...
                        <button type="submit" data-auth-visibility-target="loginButton" 
                            ...
                            <span data-auth-visibility-target="loginButtonText" class="flex items-center justify-center">
                                Sign In
                                <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/>
                                </svg>
                            </span>
                            <span data-auth-visibility-target="loginButtonSpinner" class="hidden">
